        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7 wow bounceInUp" data-wow-delay="0.3s">
                    ...
                    <a href="" class="btn btn-primary py-3 px-5 rounded-pill">Lihat Selebihnya<i
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="footer-item">
                        ...
                        <p class="lh-lg mb-4">Alun Alun Yogyakarta merupakan pusat kegiatan masyarakat serta menjadi jantung yang menghidupkan kegiatan sehari-hari dan mengemban nilai-nilai budaya yang kaya di Yogyakarta.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center d-flex justify-content-center text-md-start mb-3 mb-md-0">
                    <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Alun Alun</a>,
                        Yogyakarta.</span>
                </div>
